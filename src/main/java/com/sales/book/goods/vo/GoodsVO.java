package com.sales.book.goods.vo;
...
public class GoodsVO {
	...
	public String toString() {
		return "GoodsVO [goods_id=" + goods_id + ", goods_title=" + goods_title + ", goods_writer=" + goods_writer
				+ ", goods_price=" + goods_price + ", goods_publisher=" + goods_publisher + ", goods_sort=" + goods_sort
				+ ", goods_sales_price=" + goods_sales_price + ", goods_point=" + goods_point
				...
				+ ", goods_status=" + goods_status + ", goods_credate=" + goods_credate + "]";
	}
