...
public class CartListVO {
	...
	public String toString() {
		return "CartListVO [cart_id=" + cart_id + ", goods_id=" + goods_id + ", member_id=" + member_id
				+ ", cart_goods_qty=" + cart_goods_qty + ", goods_title=" + goods_title + ", goods_writer="
				+ goods_writer + ", goods_price=" + goods_price + ", goods_publisher=" + goods_publisher
				+ ", goods_sort=" + goods_sort + ", goods_sales_price=" + goods_sales_price + ", goods_point="
				+ goods_point + ", goods_published_date=" + goods_published_date + ", goods_total_page="
				+ goods_total_page + ", goods_isbn=" + goods_isbn + ", goods_delivery_price=" + goods_delivery_price
				+ ", goods_delivery_date=" + goods_delivery_date + ", goods_fileName=" + goods_fileName
				+ ", goods_status=" + goods_status + ", goods_writer_intro=" + goods_writer_intro
				+ ", goods_contents_order=" + goods_contents_order + ", goods_intro=" + goods_intro
				+ ", goods_publisher_comment=" + goods_publisher_comment + ", goods_recommendation="
				+ goods_recommendation + ", goods_credate=" + goods_credate + "]";
	}
