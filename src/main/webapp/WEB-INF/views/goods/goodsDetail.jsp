...
<body>
	...
	<div id="goods_image">
		<figure>
			<img alt="HTML5 &amp; CSS3"
				src="${contextPath}/thumbnails.do?goods_id=${goods.goods_id}&goods_fileName=${goods.goods_fileName}">
		</figure>
	</div>
	<div id="detail_table">
		<table>
		...
		<div class="tab_container">
			<div class="tab_content" id="tab1">
				...
				<c:forEach var="image" items="${imageList }">
					<img 
						src="${contextPath}/download.do?goods_id=${goods.goods_id}&goods_fileName=${image.fileName}">
				</c:forEach>
			</div>
