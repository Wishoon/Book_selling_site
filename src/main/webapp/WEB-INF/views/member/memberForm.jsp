...
<script>
	...
	function pwCheck(pw) {
		$.ajax({
			type : "POST",
			url : "${contextPath}/member/effectiveness",
			data : {pw:pw},
			success:function(result){
				if(result == true){
					pwCheckF.innerHTML = "가능한 비밀번호 입니다";
				}
				else{
					pwCheckF.innerHTML = "사용할 수 없는 비밀번호 입니다";
				}
			},
			error:function(){
				alert("에러가 발생했습니다.");
			...
			<table>
				<tbody>
					...
					<tr class="dot_line">
						...
						<td>
							<input name="member_pw" type="password" id="pw" size="20" oninput="pwCheck(pw.value)" />
							<span id="pwCheckF" style="font-size: 10pt; color: #FF6600; margin: 0;"></span>
						</td>
					</tr>
					<tr class="dot_line">
						<td class="fixed_join">비밀번호 확인</td>
						<td>
							<input name="member_pw_check" type="password" id="repw" size="20" />
							<span id="pwCheckFF" style="font-size: 10pt; color: #FF6600; margin: 0;"></span>
						</td>
					</tr>
					<tr class="dot_line">
					...
					<tr class="dot_line">
						...
						</select> - <input size="10px" type="text" name="member_hp2"> - <input
							size="10px" type="text" name="member_hp3"><br> <br> <input
					...
					<tr class="dot_line">
						...
						<td><input size="10px" type="text" name="member_email1" /> @ <input
							size="10px" type="text" name="member_email2" /> <select name="email2"
							onChange="" title="직접입력">
					...
					<tr class="dot_line">
						...
						<td><input type="text" id="zipcode" name="post_code"
							size="10"> <a href="javascript:execDaumPostcode()">우편번호검색</a>
							<br>
							<p>
								지번 주소:<br>
								<input type="text" id="roadAddress" name="parcel_address"
									size="50"><br>
								<br> 도로명 주소: <input type="text" id="jibunAddress"
									name="street_address" size="50"><br>
								<br> 나머지 주소: <input type="text" name="detail_address"
									size="50" />
