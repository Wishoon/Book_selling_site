...
function search_goods_list(fixedSearchPeriod){
	...
	var day = document.getElementById("curDay");
	
	var formObj=document.createElement("form");
	var i_fixedSearch_period = document.createElement("input");
	var i_year = document.createElement("input");
	var i_month = document.createElement("input");
	var i_day = document.createElement("input");
	i_fixedSearch_period.name="fixedSearchPeriod";
	i_fixedSearch_period.value=fixedSearchPeriod;
	
	i_year.name="beginYear";
	i_year.value=year.options[year.selectedIndex].value;
	
	i_month.name="beginMonth";
	i_month.value=month.options[month.selectedIndex].value;
	
	i_day.name="beginDay";
	i_day.value=day.options[day.selectedIndex].value;
	
	formObj.appendChild(i_fixedSearch_period);
    formObj.appendChild(i_year);
    formObj.appendChild(i_month);
    formObj.appendChild(i_day);
		...
		<TABLE cellpadding="10" cellspacing="10"  >
			<TBODY>
				...
				<TR >
					...
					</select>년 <select name="curMonth" id="curMonth">
